...
def _commit_type_icon_svg(commit_type: str) -> str:
    """Return a hand-drawn line icon for the commit category."""

    icons = {
        "FEAT": '<g data-commit-icon="feat" fill="none" stroke="#24292F" stroke-linecap="round" stroke-linejoin="round"><path d="M45 48 C45 54 42 58 36 61 C42 62 45 66 46 73 C48 66 51 62 57 60 C51 58 48 54 45 48Z" stroke-width="2.3"/><path d="M34 51 L36 54 M55 69 L58 72" stroke-width="1.8"/></g>',
        "FIX": '<g data-commit-icon="fix" fill="none" stroke="#24292F" stroke-linecap="round" stroke-linejoin="round"><path d="M51 48 C55 48 58 50 59 53 L54 57 L50 53 L54 49 M51 56 L38 70 C36 72 32 69 35 66 L48 53" stroke-width="2.5"/><circle cx="37" cy="68" r="1.4" fill="#24292F" stroke="none"/></g>',
        "REFACTOR": '<g data-commit-icon="refactor" fill="none" stroke="#24292F" stroke-linecap="round"><path d="M38 51 C38 59 37 65 38 72 M40 56 C47 56 52 59 52 66" stroke-width="2.4"/><circle cx="38" cy="50" r="3.4" stroke-width="2"/><circle cx="38" cy="73" r="3.4" stroke-width="2"/><circle cx="52" cy="69" r="3.4" stroke-width="2"/></g>',
        "DOCS": '<g data-commit-icon="docs" fill="none" stroke="#24292F" stroke-linecap="round" stroke-linejoin="round"><path d="M31 52 C36 50 41 51 45 54 C49 51 54 50 59 52 L58 71 C53 69 49 70 45 73 C41 70 37 69 32 71Z" stroke-width="2.3"/><path d="M45 54 C44 61 46 66 45 73 M35 57 C38 56 40 57 42 58 M49 58 C52 56 54 57 56 57" stroke-width="1.7"/></g>',
        "TEST": '<g data-commit-icon="test" fill="none" stroke="#24292F" stroke-linecap="round" stroke-linejoin="round"><path d="M39 49 C43 50 47 49 51 49 M42 50 L42 57 L35 69 C34 72 37 74 40 74 L54 73 C57 73 58 70 56 67 L50 57 L50 50" stroke-width="2.3"/><path d="M38 66 C43 63 48 70 54 64" stroke-width="1.8"/><circle cx="51" cy="61" r="1.4" fill="#24292F" stroke="none"/></g>',
        "PERF": '<g data-commit-icon="perf" fill="none" stroke="#24292F" stroke-linecap="round" stroke-linejoin="round"><path d="M33 68 C32 57 38 49 46 48 C55 48 61 57 59 68" stroke-width="2.5"/><path d="M37 68 C42 66 50 66 56 68 M45 64 L53 53" stroke-width="2.5"/><circle cx="45" cy="64" r="2.2" fill="#24292F" stroke="none"/><path d="M31 54 L27 52 M59 53 L63 50 M45 46 L45 42" stroke-width="1.8"/></g>',
        "BUILD": '<g data-commit-icon="build" fill="none" stroke="#24292F" stroke-linecap="round" stroke-linejoin="round"><path d="M34 54 L44 49 L55 53 L56 65 L46 72 L35 66Z" stroke-width="2.3"/><path d="M34 54 L45 59 L55 53 M45 59 L46 72 M40 51 L51 56" stroke-width="1.8"/></g>',
        "CI": '<g data-commit-icon="ci" fill="none" stroke="#24292F" stroke-linecap="round" stroke-linejoin="round"><path d="M35 57 C38 49 50 47 56 54 M52 49 L56 54 L50 56 M56 65 C52 74 39 75 34 67 M39 72 L34 67 L40 64" stroke-width="2.4"/><path d="M44 57 L48 61 L43 66" stroke-width="1.8"/></g>',
        "STYLE": '<g data-commit-icon="style" fill="none" stroke="#24292F" stroke-linecap="round" stroke-linejoin="round"><path d="M52 48 C58 53 55 58 50 62 L43 69 C40 72 35 72 32 70 C37 67 35 63 39 60 L50 49Z" stroke-width="2.3"/><path d="M35 72 C39 75 44 73 46 70 M50 54 L54 58" stroke-width="1.7"/></g>',
        "REVERT": '<g data-commit-icon="revert" fill="none" stroke="#24292F" stroke-linecap="round" stroke-linejoin="round"><path d="M38 54 L31 61 L38 67 M32 61 C39 59 49 58 55 63 C60 67 57 73 52 75" stroke-width="2.6"/><path d="M47 75 C50 74 53 75 55 72" stroke-width="1.5"/></g>',
        "CHORE": '<g data-commit-icon="chore" fill="none" stroke="#24292F" stroke-linecap="round" stroke-linejoin="round"><path d="M39 48 C42 54 46 60 50 67" stroke-width="2.8"/><path d="M47 65 L56 60 C58 65 57 70 53 74 C49 73 46 70 44 67Z" stroke-width="2.2"/><path d="M49 69 L55 66 M51 72 L56 69 M34 68 L31 70 M34 63 L30 62" stroke-width="1.7"/></g>',
        "COMMIT": '<g data-commit-icon="commit" fill="none" stroke="#24292F" stroke-linecap="round" stroke-linejoin="round"><path d="M39 48 C38 56 40 64 39 74 M41 55 C48 55 52 58 52 64" stroke-width="2.5"/><circle cx="39" cy="49" r="3.5" fill="#FFFFFF" stroke-width="2"/><circle cx="39" cy="74" r="3.5" fill="#FFFFFF" stroke-width="2"/><circle cx="52" cy="67" r="3.5" fill="#24292F" stroke-width="1.7"/><path d="M56 50 C59 52 60 54 61 57" stroke-width="1.7"/></g>',
    }
...
{_svg_root("title", "desc", 148, 420)}
  ...
  <g font-family="Pretendard, Noto Sans KR, Apple SD Gothic Neo, Segoe UI, sans-serif" fill="#24292F">
    <path d="M45 34 C60 34 71 44 72 60 C74 75 63 88 47 89 C30 91 18 80 18 63 C17 47 29 35 45 34Z" fill="{color}" stroke="#24292F" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M31 43 C38 37 51 36 59 42 C48 41 36 46 29 55" fill="none" stroke="#FFFFFF" stroke-width="2.2" stroke-linecap="round" opacity=".2"/>
